                    ...
                    <div class="card-body">
                        ...
                        <form method="post" class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input list="room_type_list" name="room_type" id="room_type" class="form-control" placeholder="Deluxe Room" required>
                            ...
                            <div class="col-md-6">
                                <label for="room_bedding" class="form-label">Tipo de cama</label>
                                <input type="text" name="bedding" id="room_bedding" class="form-control" placeholder="Queen" required>
                            </div>
                            <div class="col-12">
