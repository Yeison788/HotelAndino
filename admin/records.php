...
$views = [
    'rooms'      => 'Registrar habitación',
    'room-types' => 'Registrar tipo de habitación',
    'users'      => 'Registrar usuario',
    'products'   => 'Registrar producto',
    'sales'      => 'Registrar venta',
    'summary'    => 'Resumen rápido',
];

$viewDescriptions = [
    'rooms'      => 'Crea nuevas habitaciones indicando piso, estado y tipo disponible.',
    'room-types' => 'Añade los tipos de habitación que ofrece el hotel.',
    'users'      => 'Registra cuentas administrativas adicionales para el sistema.',
    'products'   => 'Controla los productos y servicios disponibles para ventas internas.',
    'sales'      => 'Registra ventas puntuales asociadas a productos y servicios.',
    'summary'    => 'Consulta los últimos movimientos registrados en habitaciones, tipos, usuarios y ventas.',
];
...
$recentRooms = $recentTypes = $recentUsers = $recentSales = null;
if ($view === 'summary') {
...
<body class="bg-light">
    <div class="container py-4">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div>
                <h2 class="mb-1"><?php echo $views[$view]; ?></h2>
                <p class="text-muted mb-0"><?php echo $viewDescriptions[$view]; ?></p>
            </div>
